...
import com.dbjdbc.jdbc.repository.MemberRepositoryV4_2;
 ...
 *
 * MemberRepository 인터페이스 활용 - 예외 누수(예외에 대한 의존) 해결하기 완료
 * 추가로 스프링 예외 변환기 (예외의 추상화) 로 에러클래스 스프링이 제공하는 것 위주로 사용하기 - repository만 바꿔줌 V4_1-> V4_2
 * MemberRepositoryV4_2 쿼리 이상하게 찍어보면 BadSqlGrammerException 이 나옴.
 * org.springframework.jdbc.BadSqlGrammarException: save; bad SQL grammar [updateㅇㅇㅇㅇㄴㄴ member2 set money=? where member_id=?]
 *
 */
@Slf4j
...
class MemberServiceV4_1Test {
    ...
    static class TestConfig {
        ...
        } // 외부주입되는 리포지터리만 바꿔도 적용바로가능, 인터페이스를 쓰는 이유임. 변경이 아주 쉬워진다.
        @Bean
...
//        memberRepository.save(memberB);
    ...
    @Test
    @DisplayName("쿼리잘못 짯을 때 badSqlGrammer 스프링제공 예외 뜨게하기")
    void badSqlGrammer() {
