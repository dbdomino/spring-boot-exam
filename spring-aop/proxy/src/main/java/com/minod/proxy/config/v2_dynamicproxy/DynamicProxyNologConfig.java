...
import com.minod.proxy.config.v2_dynamicproxy.handler.LogTraceNologHandler;
...
//        Object proxyInstance = Proxy.newProxyInstance(OrderRepositoryV1.class.getClassLoader(), new Class[]{OrderRepositoryV1.class}, new LogTraceBasicHandler(orderController, logTracer));
        OrderControllerV1 proxyInstance = (OrderControllerV1) Proxy.newProxyInstance(OrderControllerV1.class.getClassLoader(), new Class[]{OrderControllerV1.class}, new LogTraceNologHandler(orderController, logTracer, PATTERNS));
    ...
    public OrderServiceV1 orderServiceV1(LogTracer logTracer) {
        ...
        OrderServiceV1 proxyInstance = (OrderServiceV1) Proxy.newProxyInstance(OrderServiceV1.class.getClassLoader(), new Class[]{OrderServiceV1.class}, new LogTraceNologHandler(orderService, logTracer, PATTERNS));
        return proxyInstance;
    }
    ...
    public OrderRepositoryV1 orderRepositoryV1(LogTracer logTracer) {
        ...
        OrderRepositoryV1 proxyInstance = (OrderRepositoryV1) Proxy.newProxyInstance(OrderRepositoryV1.class.getClassLoader(), new Class[]{OrderRepositoryV1.class}, new LogTraceNologHandler(orderRepository, logTracer, PATTERNS));
        return proxyInstance;
    }
